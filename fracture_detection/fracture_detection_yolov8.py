...
def main():
    ...
    if uploaded_files:
        ...
        if st.button("Start detection"):
            ...
            model = YOLO("C:\\Users\\18301\\OneDrive\\Desktop\\FractureDetection1.2\\fracture_detection\\yolov8m_10.16.pt")  # Load model here
            ...
            st.write(f"Output files: {len(output_files)}")  # 添加此行以确认输出数量
